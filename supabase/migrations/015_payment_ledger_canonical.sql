-- ============================================================================
-- EXECUTION MARKET: Canonical payment ledger compatibility migration
-- Migration: 015_payment_ledger_canonical.sql
-- Date: 2026-02-06
--
-- Goal:
-- - Ensure `escrows` and `payments` tables exist in production.
-- - Ensure canonical columns required by the API contract exist:
--   task_id, submission_id, type, status, tx_hash, amount_usdc, network, created_at
-- - Keep backward compatibility with legacy column names:
...
-- --------------------------------------------------------------------------
-- ESCROWS (minimal, compatibility-first)
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- PAYMENTS (canonical ledger + legacy aliases)
-- --------------------------------------------------------------------------
...
-- Backfill canonical aliases when possible.
UPDATE payments
SET
...
-- Strong defaults for future writes.
