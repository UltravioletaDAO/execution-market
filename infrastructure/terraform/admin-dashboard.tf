...
#   terraform import aws_s3_bucket_public_access_block.admin_dashboard em-production-admin-dashboard
#   terraform import aws_cloudfront_distribution.admin_dashboard E2IUZLTDUFIAQP
#   terraform import aws_s3_bucket_policy.admin_dashboard em-production-admin-dashboard
#   terraform import aws_route53_record.admin_dashboard <ZONE_ID>_admin.execution.market_A
