...
def get_category_checks(task: dict) -> str:
    """Return category-specific verification instructions for simple action tasks.
    ...
    the submitted photo evidence proves the worker completed the requested
    action (purchase, delivery, etc.).
