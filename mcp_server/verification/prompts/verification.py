...
def get_category_checks(task: dict) -> str:
    """Return category-specific verification instructions for general verification tasks.
    ...
    the submitted photo evidence adequately documents and verifies the subject.
