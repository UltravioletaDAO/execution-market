"""
Phase B — Evidence Verification Check Helpers

Shared helpers for AI + image-analysis checks that require actual pixel
data (as opposed to Phase A metadata-only checks). The orchestration that
used to live here was migrated to SQS + Lambda after INC-2026-04-12; this
module now only exposes the individual check functions used by the Lambda
