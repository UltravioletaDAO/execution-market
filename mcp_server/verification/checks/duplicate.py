...
class DuplicateDetector:
    ...
    def compute_similarity(
        self,
        hash1: Tuple[str, str, str],
        hash2: Tuple[str, str, str]
    ) -> float:
        """
    ...
    def check_duplicate(
        ...
        try:
            ...
            return DuplicateResult(
                ...
                phash=new_hashes[0],
                reason=f"Image is {best_similarity*100:.1f}% similar to existing photo {best_match_id}" if is_duplicate else None
            )
