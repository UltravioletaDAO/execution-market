"""
Post-Audit Phase 1 Tests — Payment Safety
...
These mirror test_audit_phase1_payment_safety.py for the canonical
`test_post_audit_phase1.py` naming convention.
"""
...
class TestCheckSubmissionCaseInsensitiveAgentId:
    ...
    async def test_check_submission_case_insensitive_agent_id(self, task_id, agent_id):
        ...
        mock_db.get_applications_for_task = AsyncMock(return_value=[])
