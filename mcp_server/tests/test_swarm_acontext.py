...
@pytest.fixture
def acontext():
    return AcontextAdapter(irc_host="localhost", port=6667, channel="#test-channel", nickname="TestAgent")
...
def test_parse_message_sets_lock(acontext):
    msg = ":Agent2!user@host PRIVMSG #test-channel :!intent Agent2 worker_xyz moderation"
...
def test_parse_release_removes_lock(acontext):
    msg_intent = ":Agent2!user@host PRIVMSG #test-channel :!intent Agent2 worker_xyz moderation"
