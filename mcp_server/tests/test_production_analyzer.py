...
class TestWorkerAnalysis:
    ...
    def test_multiple_workers_sorted(self):
        ...
        tasks = (
            [
                make_task(task_id=f"a{i}", worker_wallet="0xTOP", status="completed")
                for i in range(10)
            ]
            + [
                make_task(task_id=f"b{i}", worker_wallet="0xMID", status="completed")
                for i in range(5)
            ]
            + [
                make_task(task_id=f"c{i}", worker_wallet="0xBOT", status="completed")
                for i in range(2)
            ]
        )
    ...
    def test_avg_tasks_per_worker(self):
        ...
        tasks = [
            make_task(task_id=f"a{i}", worker_wallet="0xA", status="completed")
            for i in range(6)
        ] + [
            make_task(task_id=f"b{i}", worker_wallet="0xB", status="completed")
            for i in range(4)
        ]
