...
## Karpathy's 4 Coding Rules (apendido 2026-05-04)

> Behavioral guidelines from [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md). **Operate under these 4 rules going forward.** These bias toward caution over speed — use judgment for trivial tasks.
