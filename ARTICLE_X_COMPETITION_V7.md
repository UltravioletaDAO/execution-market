...
> V7 - Handles finales + ejemplos realistas + costos estimados
...
Solo un mensaje en tu teléfono: "Verificar que la tienda en 5th Avenue está abierta. $0.50. Tienes 15 minutos."
...
| Verificar horario de farmacia | 10 min | $3.00 |
| Verificar que propiedad inmobiliaria existe | 30 min | $5.00 |
| Entregar paquete urgente | 1-2 horas | $15-25 |
...
| Tarea | Tiempo | Pago |
|-------|--------|------|
| Tomar foto de menú de restaurante | 10 min | $0.75 |
| Escanear páginas 45-52 de libro específico | 1 hora | $12.50 |
| Fotografiar documentos en archivo municipal | 2 horas | $20.00 |
| Obtener artículo académico de biblioteca | 2 horas | $20.00 |
| Transcribir letrero antiguo ilegible | 30 min | $8.00 |
...
| Tramitar documentos en corte | 1-2 días | $200.00 |
| Peritar daños en propiedad | 2-4 horas | $100-200 |
| Certificar traducción oficial | 1-2 días | $80-150 |

### D. Acciones Físicas Simples ($2 - $30)
Hacer algo específico y delimitado.

| Tarea | Tiempo | Pago |
|-------|--------|------|
| Comprar producto específico y fotografiar | 45 min | $8.00 |
| Verificar stock de consolas en Best Buy | 30 min | $10.00 |
| Medir dimensiones de espacio | 30 min | $12.00 |
| Recoger muestra de agua para análisis | 1 hora | $15.00 |
| Instalar sensor IoT simple | 1-2 horas | $25-30 |
...
| Tarea | Tiempo | Pago |
|-------|--------|------|
| Documentar menú y precios de café | 30 min | $8.00 |
| Verificar precios online vs tienda física | 1 hora | $15.00 |
| Digitalizar colección de fotos antiguas | 2-4 horas | $30-40 |
| Configurar dispositivo IoT en ubicación | 1-2 horas | $20-35 |
| Verificar QR codes en múltiples ubicaciones | 2 horas | $18.00 |

---

Estas no son tareas inventadas. Son ejemplos reales de cosas que los agentes de IA ya necesitan y no pueden hacer.

Un agente inmobiliario necesita verificar que una propiedad existe. **$5.**
Un agente de investigación necesita páginas de un libro que no está digitalizado. **$12.50.**
Un agente legal necesita que alguien notarice un documento. **$150.**
...
El protocolo x402 de @x402Foundation + @coinaborateur permite pagar por request. Literalmente. HTTP + pago integrado. Sin cuentas. Sin intermediarios.
...
ERC-8004 por @marco_derossi y @DavideCrapis. Cada participante - humano, agente, o eventualmente robot - tiene identidad verificable.

Un agente va a preferir contratar a alguien con 500 tareas completadas y score de 87/100 que a uno nuevo sin historial.

Reputación pública. Escala de 0-100. Inmutable. Imposible de manipular.

### Verificación por consenso

No hay un solo juez. Múltiples validadores por trabajo. AI pre-verifica, humano confirma si es necesario. Consenso 2-de-3 usando @safe.

Y lo mejor: **validar es trabajo pagado**. 5% del bounty va a validadores. Un mercado de gente cuyo trabajo es verificar que otros hicieron bien su trabajo.
...
**Con Chamba:**
1. Agente publica: "Enviar paquete a FedEx, dirección X, $3"
2. Humano cercano la toma
3. Va, envía, sube foto de recibo con tracking
4. Sistema verifica automáticamente (OCR + geolocalización)
...
Apps especializadas para nichos específicos (verificaciones inmobiliarias, entregas de documentos, auditorías de retail).
...
Una empresa de logística con agentes que publican tareas de verificación, y empleados que las toman como parte de su trabajo. Gamificado. Trackeado. Medido. Leaderboard mensual. El que más tareas completa gana reconocimiento.
...
Gente con robots domésticos. Registrándolos en el protocolo. Los robots tomando tareas automáticamente mientras sus dueños duermen. Generando ingresos pasivos.

Empresas con flotas de drones. Registrándolos para tareas de verificación aérea.
...
| V7 | 2026-01-21 | Handles finales, FedEx, ejemplos realistas del seed con costos |
