...
# Login
aws ecr get-login-password --region us-east-2 | \
  cmd //c "docker login --username AWS --password-stdin 518898403364.dkr.ecr.us-east-2.amazonaws.com"
...
cmd //c "cd /d Z:\ultravioleta\dao\control-plane\ideas\chamba\mcp_server && \
  ...
  docker tag chamba-mcp-server:latest 518898403364.dkr.ecr.us-east-2.amazonaws.com/chamba-mcp-server:latest && \
  docker push 518898403364.dkr.ecr.us-east-2.amazonaws.com/chamba-mcp-server:latest"
...
cmd //c "cd /d Z:\ultravioleta\dao\control-plane\ideas\chamba\dashboard && \
  ...
  docker tag chamba-dashboard:latest 518898403364.dkr.ecr.us-east-2.amazonaws.com/chamba-dashboard:latest && \
  docker push 518898403364.dkr.ecr.us-east-2.amazonaws.com/chamba-dashboard:latest"
```
