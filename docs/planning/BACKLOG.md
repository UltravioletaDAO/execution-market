...
|------|------|---------|----------|--------|
| 2026-06-11 | Recuperar $0.05 USDC lockeados huérfanos en escrow Base (TX 0x845176e7906c9b24254677e42b72a88cfbe7ea06fbc51f609cabe6d6a20ff5e2) | Run ref 24e7114a del e2e H2H: el Facilitator lockeó on-chain pero el relay crasheó parseando la respuesta (bug arreglado en 8f73fdf7) y el server hizo rollback sin persistir payment_info. Recovery: decodificar paymentInfo del calldata de la TX → refund vía Facilitator (SDK refund_in_escrow) con la wallet publisher 0x857f...43Cd. refund_expiry = +24h del lock (2026-06-12 ~18:55 UTC). | P2 | pending |
