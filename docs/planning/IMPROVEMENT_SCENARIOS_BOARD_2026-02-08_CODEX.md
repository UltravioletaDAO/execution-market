...
- [ ] `IMP-COD-005 | P0 | Rehabilitar E2E bloqueante mínimo en CI`
- [ ] `IMP-COD-006 | P1 | Corregir drift `uvd-x402-sdk` en SDK TypeScript`
- [ ] `IMP-COD-007 | P1 | Permitir `hardhat test` local sin deploy key`
- [ ] `IMP-COD-008 | P1 | Definir scope mypy bloqueante (baseline realista)`
