...
- [ ] `SCN-260208-A01 | P0 | Integrator wrong-domain trap | Trigger: client calls execution.market/api/* and gets HTML 200 | Expected: docs + edge behavior prevent silent misuse`
