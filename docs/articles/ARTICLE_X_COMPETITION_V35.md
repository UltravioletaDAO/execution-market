...
<!--
📸 IMAGEN 2: Tabla comparativa visual MTurk vs Chamba. Lado izquierdo oscuro/legacy, lado derecho brillante/moderno. Iconos para cada característica.
-->
...
```mermaid
graph LR
    A[Agente IA] -->|publica tarea| B[Chamba Protocol]
...
<!--
📸 IMAGEN 5: Diagrama lado a lado. Izquierda: "HOY" - flujo complicado con 6 pasos, flechas rojas, iconos de reloj (horas/días). Derecha: "CON CHAMBA" - flujo simple con 3 pasos, flechas verdes, iconos de rayo (segundos).
