...
```json
{
  "secrets": [
    {
      "name": "SUPABASE_URL",
      "valueFrom": "arn:aws:secretsmanager:us-east-2:518898403364:secret:chamba/production:SUPABASE_URL::"
    },
    {
      "name": "SUPABASE_SERVICE_ROLE_KEY",
      "valueFrom": "arn:aws:secretsmanager:us-east-2:518898403364:secret:chamba/production:SUPABASE_SERVICE_ROLE_KEY::"
    }
  ]
}
```
