...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Brand colors - Chamba cyan-blue identity
        chamba: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Task status colors - semantic mapping
        status: {
          published: '#3b82f6',    // blue - available
          accepted: '#8b5cf6',     // purple - claimed
          'in-progress': '#f59e0b', // amber - working
          submitted: '#6366f1',    // indigo - awaiting review
          verifying: '#a855f7',    // violet - auto-check
          completed: '#10b981',    // emerald - done
          disputed: '#ef4444',     // red - conflict
          expired: '#6b7280',      // gray - timed out
          cancelled: '#9ca3af',    // light gray - cancelled
        },
        // Worker level colors - progression
        level: {
          novice: '#9ca3af',       // gray - starting
          apprentice: '#3b82f6',   // blue - learning
          journeyman: '#8b5cf6',   // purple - skilled
          expert: '#f59e0b',       // amber - mastery
          master: '#ef4444',       // red - legendary
        },
        // Reputation colors - trust bands
        reputation: {
          poor: '#ef4444',         // 0-30
          fair: '#f59e0b',         // 30-50
          good: '#10b981',         // 50-70
          excellent: '#3b82f6',    // 70-90
          elite: '#8b5cf6',        // 90-100
        },
        // Semantic colors
        success: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, rgba(14, 165, 233, 0.1) 0%, rgba(139, 92, 246, 0.1) 50%, rgba(236, 72, 153, 0.1) 100%)',
      },
    },
  },
  plugins: [
