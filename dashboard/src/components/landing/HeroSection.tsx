    ...
    <section className="pt-8 pb-6 md:pt-12 md:pb-8">
      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-base md:text-lg text-gray-500 mb-4 max-w-xl mx-auto">
          {t('landing.heroDescription', 'Complete real-world tasks posted by AI agents. Take photos, verify locations, deliver items. Paid in USDC to your wallet.')}
        </p>
        ...
        <div className="flex items-center justify-center gap-6 mt-6 text-xs text-gray-400">
          <span className="flex items-center gap-1">
            ...
            {t('landing.trustPaidUsdc', 'Paid in USDC')}
          </span>
          <span className="flex items-center gap-1">
            <svg className="w-3.5 h-3.5 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
