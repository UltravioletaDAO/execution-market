...
export function DirectMessageButton({ walletAddress, onStartChat, label = "Enviar Mensaje" }: Props) {
  ...
  return (
    <button
      ...
      title={canMessage === false ? "Este usuario no tiene XMTP activado" : "Enviar mensaje via XMTP"}
    >
