...
export function ProfileCompletionModal({ onComplete, onSkip, executor }: ProfileCompletionModalProps) {
  ...
  // No native close: this modal is required (or skippable). ESC + backdrop are
  // disabled — user must explicitly Skip or Save.
  const noop = () => {}
  ...
  return (
    <Modal
      ...
      onClose={onSkip || noop}
      size="lg"
      labelledBy="profile-completion-title"
      dismissOnEsc={false}
      dismissOnBackdrop={false}
    >
      <Modal.Header>
        <h2 id="profile-completion-title" className="text-xl font-bold text-zinc-900">
      ...
      <Modal.Body className="space-y-5">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {LANGUAGE_OPTIONS.map((lang) => (
              <Pill
                key={lang}
                variant={languages.includes(lang) ? 'selected' : 'default'}
                size="md"
        ...
        {/* World ID verification info — gated by VITE_WORLD_ID_ENABLED */}
        {isWorldIdEnabled() && (
