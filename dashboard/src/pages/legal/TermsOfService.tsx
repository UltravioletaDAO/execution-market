...
export function TermsOfService() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-zinc-600 text-sm mb-8">Last updated: March 21, 2026</p>

      <div className="prose prose-sm max-w-none space-y-6 text-zinc-700 leading-relaxed">
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">1. Eligibility</h2>
        <p>You must be at least 18 years old and have the legal capacity to enter into a binding agreement.</p>

        <h2 className="text-xl font-semibold text-zinc-900">2. Platform Description</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">3. Task Execution</h2>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">4. Payments and Fees</h2>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h2 className="text-xl font-semibold text-zinc-900">5. Reputation System</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">6. Prohibited Conduct</h2>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h2 className="text-xl font-semibold text-zinc-900">7. Content Moderation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">8. Account Termination</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">10. Dispute Resolution</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">11. Contact</h2>
        <p>
          Ultravioleta DAO<br />
