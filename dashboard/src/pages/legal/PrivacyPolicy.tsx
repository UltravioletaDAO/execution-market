  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-zinc-700 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-zinc-900">3. Location Data</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">4. Camera and Photo Data</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">5. Blockchain Data and Permanence</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">6. Third-Party Service Providers</h2>
        <ul className="list-disc pl-5 space-y-2">
        ...
        <h2 className="text-xl font-semibold text-zinc-900">7. Data Retention and Deletion</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">8. Account Deletion</h2>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">9. Children's Privacy</h2>
        <p>The Platform is not intended for individuals under 18. We do not knowingly collect information from children under 18.</p>

        <h2 className="text-xl font-semibold text-zinc-900">10. Your Rights (GDPR / CCPA)</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-zinc-900">11. Contact Us</h2>
        <p>
          Ultravioleta DAO<br />
