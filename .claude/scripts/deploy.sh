...
#   AWS_ACCOUNT_ID  (default: 518898403364)
...
declare -A BUILD_ARGS=(
  [dashboard]="--build-arg VITE_SUPABASE_URL=https://puyhpytmtkyevnxffksl.supabase.co --build-arg VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB1eWhweXRtdGt5ZXZueGZma3NsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzYzNjM5NDgsImV4cCI6MjA1MTkzOTk0OH0.vGKpbSzYJ5MsHMEwmumL1Z8YSiXy7UPYjUftDE3kKFA --build-arg VITE_EVIDENCE_API_URL=https://vhvwpq0lu0.execute-api.us-east-2.amazonaws.com --build-arg VITE_DYNAMIC_ENVIRONMENT_ID=db513515-7317-46d6-b401-e0695f104481"
  [mcp]=""
)
