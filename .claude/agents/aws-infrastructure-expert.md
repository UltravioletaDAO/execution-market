...
**Account & Region:**
- AWS Account: `518898403364` (default profile, user `cuchorapido`)
...
- Images: `518898403364.dkr.ecr.us-east-2.amazonaws.com/em-production-dashboard:latest` and `em-production-mcp-server:latest`
...
docker tag SERVICE:latest 518898403364.dkr.ecr.us-east-2.amazonaws.com/em-production-SERVICE:latest
docker push 518898403364.dkr.ecr.us-east-2.amazonaws.com/em-production-SERVICE:latest
...
4. **ALWAYS use account `518898403364`** — never `897729094021`
