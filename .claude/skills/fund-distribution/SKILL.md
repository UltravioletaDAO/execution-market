...
|--------|---------|-----------|
| Master/Platform | `0xD3868E1eD738CED6945A574a7c769433BeD5d474` | AWS SM `em/x402:PRIVATE_KEY` |
| Dev | `0x857fe6150401bFB4641Fe0D2B2621cc3B05543Cd` | `.env.local:WALLET_PRIVATE_KEY` |
| Test Worker | `0x52E05C8e45a32eeE169639F6d2cA40f8887b5A15` | AWS SM `em/test-worker:private_key` |
| KK Agent Wallets | 24 HD-derived wallets | AWS SM `kk/swarm-seed` (mnemonic) |

## Prerequisites

- **Node.js + tsx**: `cd scripts && npm install`
- **AWS CLI configured**: Account `518898403364`, region `us-east-2`
