#!/usr/bin/env python3
"""
Quick script to post an Execution Market task.
...
# Add parent dir to path for em module
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

from em import ExecutionMarketClient, TaskCategory
...
def main():
    ...
    api_key = os.environ.get("EXECUTION_MARKET_API_KEY")
    if not api_key:
        print("Error: EXECUTION_MARKET_API_KEY environment variable not set")
        sys.exit(1)

    client = ExecutionMarketClient(api_key=api_key)
